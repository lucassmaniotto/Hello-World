  ...
  return (
    <>
      ...
      >
        ...
        <p className={styles.paragraph}>
          Se você chegou até aqui, obrigado por ler e querer me conhecer um pouquinho! Espero que tenha gostado do meu site e que possamos nos conhecer melhor. Se quiser entrar em contato comigo, pode me mandar um e-mail em <a className={styles.ancor} href="mailto:lucas91755@gmail.com">lucas91755@gmail.com</a> ou em <a className={styles.ancor} href="mailto:lucas.schuch@estudante.uffs.edu.br">lucas.schuch@estudante.ufss.edu.br</a>. Aproveite sua estadia por aqui e volte sempre! :D
        </p>
